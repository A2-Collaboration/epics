...
outfile="/home/a2cb/cbrem/data/lastBremCalc.dat"
pngfile="/home/a2cb/cbrem/data/lastBremCalc.png"
use_epics="n";
phi="0";
pitch_off="0";
yaw_off="0";
...
root -b -l -q /home/a2cb/cbrem/scripts/drawModes.C'( 1, '$cmrad', '$imrad', '$phi', '$yaw_off', '$pitch_off', '$para_mode', '$perp_mode', '$pngfilearg')';
