...
Eta_4He.lines = [
       ...
       [EpicsEntry("ESum Low","CB:CB:TRIG:ESum_Low","kHz",1./1000), EpicsEntry("ESum High","CB:CB:TRIG:ESum_High","kHz",1./1000), EpicsEntry("Fast Clear","TRIG:FastClear","kHz",1.0/1000), Dummy()],
       [EpicsEntry("TAPS CFD","TAPS:BAF:TRIG:CFD:OR","kHz",1./1000), EpicsEntry("TAPS LED1","TAPS:BAF:TRIG:LED1:OR","kHz",1.0/1000), EpicsEntry("NMR","TAGG:MagneticField","mT",1000), Dummy()],
       [EpicsEntry("TAPS LED2","TAPS:BAF:TRIG:LED2:M2Plus","kHz",1.0/1000), EpicsEntry("Pi0/10k","GEN:MON:Pi0PerScRead","",1.0), Dummy(), Dummy()],
       [],
       [EpicsEntry("MWPC CH0 HV","CB:MWPC:HV:CH0:Vmon:RBV","V",1.0), EpicsEntry("MWPC CH0 Imon","CB:MWPC:HV:CH0:Imon:RBV","uA",1.0), Dummy()],
       [EpicsEntry("MWPC CH1 HV","CB:MWPC:HV:CH1:Vmon:RBV","V",1.0), EpicsEntry("MWPC CH1 Imon","CB:MWPC:HV:CH1:Imon:RBV","uA",1.0), Dummy()],
       [],
       [EpicsEntry("Target pot temp","TARGET:HE:PT100_4","K"), EpicsEntry("4He Target Pressure","TARGET:HE:P_TCELL_Vac","mbar"), Dummy()],
...
CohPi0_4He = NewRunSet("CohPi0_4He",100)
CohPi0_4He.lines = [
       [RunEntry()],
       [],
       [StaticValue("Energy","1557 MeV"), StaticValue("Collimator","2 mm"), StaticValue("Set-Current (diamond/moeller)","1.35/3.2 nA"), Dummy()],
       [StaticValue("Target","4He"), StaticValue("Trigger","CB Esum > 70 MeV OR TAPS M2+"), Dummy(), Dummy()],
       [],
       [RadEntry2(), Dummy()],
       [],
       [EpicsEntry("P2 Rate","BEAM:IonChamber","kHz",1./1000), EpicsEntry("Tagger OR","TAGG:TAGG:ReferenceOR","kHz",1.0/1000), EpicsEntry("Ladder /P2","TAGG:TAGG:LadderP2Ratio","",1.0), Dummy()],
...
Tests_Feb_17 = NewRunSet("Tests_Feb_17",100)
Tests_Feb_17.lines = [
       [RunEntry()],
       [],
       [StaticValue("Energy","1604 MeV"), StaticValue("Collimator","2 mm"), StaticValue("Set-Current: ","45 nA"), Dummy()],
#       [StaticValue("Target","CH2"), StaticValue("Trigger","CB Esum > 40 MeV, M4+ (TAPS LED1/LED2 to 80 MeV)"), Dummy(), Dummy()],
       [StaticValue("Target","CH2"), StaticValue("Trigger","CB Esum > 200 MeV, M3/4, M4+ (TAPS LED1/LED2 to 80 MeV)"), Dummy(), Dummy()],
#       [StaticValue("Target","CH2"), StaticValue("Trigger","CB Esum > 100 MeV, M3/8, M4+ (TAPS LED1/LED2 to 80 MeV)"), Dummy(), Dummy()],
       [],
       [RadEntry(), Dummy()],
       [],
       [EpicsEntry("TAPS E CFD", "TAPS:BAF:SectorE:TRIG:CFD:OR","kHz",1./1000), EpicsEntry("TAPS F CFD", "TAPS:BAF:SectorF:TRIG:CFD:OR","kHz",1./1000), Dummy()],
       [EpicsEntry("TAPS D CFD", "TAPS:BAF:SectorD:TRIG:CFD:OR","kHz",1./1000), EpicsEntry("TAPS A CFD", "TAPS:BAF:SectorA:TRIG:CFD:OR","kHz",1./1000), Dummy()],
       [EpicsEntry("TAPS C CFD", "TAPS:BAF:SectorC:TRIG:CFD:OR","kHz",1./1000), EpicsEntry("TAPS B CFD", "TAPS:BAF:SectorB:TRIG:CFD:OR","kHz",1./1000), Dummy()],
       [],
       [EpicsEntry("Faraday","BEAM:FaradayCup","nA",1./1000), EpicsEntry("P2 Rate","BEAM:IonChamber","kHz",1./1000), Dummy()],
       [EpicsEntry("Interrupt","TRIG:Trigger","kHz",1./1000), EpicsEntry("Livetime","TRIG:TotalLivetime","%",1.0),Dummy()],
       [EpicsEntry("TAPS CFD","TAPS:BAF:TRIG:CFD:OR","kHz",1./1000), EpicsEntry("TAPS LED1","TAPS:BAF:TRIG:LED1:OR","kHz",1.0/1000), EpicsEntry("TAPS LED2","TAPS:BAF:TRIG:LED2:M2Plus","kHz",1.0/1000)],
       [],
       [EpicsEntry("CB ESumLow","CB:CB:TRIG:ESum_Low","kHz",1./1000), EpicsEntry("Fast Clear","TRIG:FastClear","kHz",1.0/1000),EpicsMnp()],
       [EpicsEntry("CB ESumHigh","CB:CB:TRIG:ESum_High","kHz",1./1000),Dummy(),                                                 EpicsEntry("M1","TRIG:MULT:M1","kHz",1.0/1000)],
       [Dummy(),                                                       Dummy(),                                                 EpicsEntry("M2","TRIG:MULT:M2","kHz",1.0/1000)],
       ...
       [EpicsEntry("NMR","TAGG:MagneticField","mT",1000),              Dummy(),                                                 Dummy()],
       [],
       [YesNoValue("Taps Fan failure status","Check crate: TAPS fan status ok? ","OK","stop run for fixing"), Dummy(), Dummy()],
       [YesNoValue("Helicity Information","Check POL QUELLE Moudule: ok? ","OK","stop run for fixing"), Dummy(), Dummy()],
       ]

LD2_Meson_production = NewRunSet("LD2 Meson production",100)
LD2_Meson_production.lines = [
       [RunEntry()],
       [],
       [StaticValue("Energy","1557 MeV"), StaticValue("Collimator","3 mm"), StaticValue("Set-Current","1.6 nA"), Dummy()],
       [StaticValue("Target","LD2"), StaticValue("Trigger","CB Esum > 110 MeV OR TAPS M2+ !Cerenkov "), Dummy(), Dummy()],
       [],
       [RadEntry2(), Dummy()],
       [],
       [EpicsEntry("P2 Rate","BEAM:IonChamber","kHz",1./1000), EpicsEntry("Tagger OR","TAGG:TAGG:ReferenceOR","kHz",1.0/1000), EpicsEntry("Ladder /P2","TAGG:TAGG:LadderP2Ratio","",1.0), Dummy()],
...
RunsetList = [E2M1, TaggEff, ShiftSummary ]
